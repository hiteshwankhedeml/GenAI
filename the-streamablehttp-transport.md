...
* Enables MCP clients to connect to remotely hosted servers over HTTP connections
...
* The following message types become difficult to implement with plain HTTP:
