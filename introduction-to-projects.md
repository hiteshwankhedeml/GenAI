...
* We can keep it private or share with organization



**Project instructions:**

* Tell Claude how to behave across all conversations in this project. Click on "Instructions" to open the instructions panel.
* Apply to every chat in this project and work alongside any user preferences and styles you've set
*
