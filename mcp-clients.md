...
* MCP client serves as the communication bridge between your server and MCP servers
* Client and server can communicate over different protocols depending on your setup
