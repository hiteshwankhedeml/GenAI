...
* Here in the goal, we have used a variable for input

**Agents:**

1. Researcher ⇒ will do web search ⇒ For this we will use serper
2. Content Creater ⇒ Summarization

**Steps:**

* Define tools
* Define agent, attach tool with it
*
