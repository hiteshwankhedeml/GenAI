...
* We were able to quantise Sarvam-Translate using Post-Training Quantization (PTQ), leveraging a large and diverse calibration dataset to ensure robust 8-bit inference performance.
