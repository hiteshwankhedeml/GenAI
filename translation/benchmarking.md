...
* <mark style="color:purple;background-color:purple;">**It also gave faster inference, so we selected it for Phase 1. ⇒ 1 to 2 seconds for each sentence on 8 core CPU**</mark>
