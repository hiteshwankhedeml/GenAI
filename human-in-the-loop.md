...
* <mark style="color:$danger;background-color:purple;">**We need to use checkpointer in this**</mark>
* <mark style="color:$danger;background-color:purple;">**During compile we can specify interrupt\_before or interrupt\_after which node**</mark>
* <mark style="color:$danger;background-color:purple;">**Graph will invoked with a thread it and it will interrupt for human input**</mark>
* <mark style="color:$danger;background-color:purple;">**Human input will be taken outside the system**</mark>
* <mark style="color:$danger;background-color:purple;">**After the input we will again invoke the graph with the same thread\_id and human input, and it will continue the process**</mark>
