...
* Markdown is human readable as well as LLM freindly, it required fewer tokens compared to other formats
* json is used for extraction&#x20;
* json allows for metadata like bounding boxes etc
